...
# SHAP Explanation
shap.initjs()
explainer = shap.DeepExplainer(vgg_model, train_images[:100])
shap_values = explainer.shap_values(val_images[:10])
...
display_superimposed_image(image_folder_path, heatmap)
